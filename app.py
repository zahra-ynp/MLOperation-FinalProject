...
class AttritionDeskApp:
    def __init__(self):
        ...
        self.scaler = joblib.load('artifacts/scalers/scaler.pkl')  
        self.encoder = joblib.load('artifacts/encoders/encoder.pkl')
    ...
    def show_home(self):
        ...
        st.image("images/app/homepage.png", use_container_width=True)
        ...
        st.write("""
                ...
                """)
        st.image("images/app/get-started-image.jpg", use_container_width=True)

    def show_prediction(self):
        # Prediction page
        st.title("Make a Prediction")
        st.image("images/app/leave-or-stay.png", use_container_width=True)
        ...
        if st.button("Predict"):
            try:
                ...
                if prediction[0] == 1:
                    ...
                    st.image("images/app/leave.jpg", use_container_width=True)
                else:
                    st.success("The employee is likely to stay.")
                    st.image("images/app/stay.png", use_container_width=True)
